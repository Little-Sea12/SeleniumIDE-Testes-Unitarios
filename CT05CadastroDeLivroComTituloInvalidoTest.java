...
import java.net.URL;
public class CT05CadastroDeLivroComTituloInvalidoTest {
  ...
  @Test
  public void cT05CadastroDeLivroComTituloInvalido() {
    ...
    driver.findElement(By.id("isbn")).sendKeys("7070");
    driver.findElement(By.id("autor")).click();
    driver.findElement(By.id("autor")).sendKeys("CS Lewis");
