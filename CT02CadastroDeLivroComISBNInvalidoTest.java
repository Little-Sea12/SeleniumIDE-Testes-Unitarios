...
import java.net.URL;
public class CT02CadastroDeLivroComISBNInvalidoTest {
  ...
  @Test
  public void cT02CadastroDeLivroComISBNInvalido() {
    driver.get("https://ts-scel-web.herokuapp.com/login");
    driver.manage().window().setSize(new Dimension(1294, 752));
    ...
    driver.findElement(By.id("autor")).sendKeys("Steve Jobs");
    driver.findElement(By.cssSelector(".row:nth-child(4)")).click();
    driver.findElement(By.id("titulo")).click();
    driver.findElement(By.id("titulo")).sendKeys("Apple");
